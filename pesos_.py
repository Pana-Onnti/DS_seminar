...
from Transform.transform_to_db import descargar_datos_db
...
class Datos():
    ...
    def pedir_datos(self):
        ...
        precios_brutos = descargar_datos_db('Definitivo_v1',start=self.start,end=self.end,path_to_db=path_to_db)
